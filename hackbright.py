...
def get_project_by_title(title):
	...
	print("Project: {}: {} with max grade {}".format(row[0], row[1], row[2]))
...
def get_grade_by_github_title(github, title):
	...
	print("The student earned a grade of {} on project {}.".format(row[0], row[1]))
...
def assign_grade(github, title, grade):
	...
	print(f"Your grade has been added:{title} got a {grade} percent")
